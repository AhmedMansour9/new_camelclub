...
class SaerchDialog extends StatefulWidget {

  SaerchDialog();

  @override
  State<SaerchDialog> createState() => _SaerchDialogState();
}

class _SaerchDialogState extends State<SaerchDialog> {
  late File? file = null;
                  ...
                  child: CustomButton(
                    ...
                    onTap: () async {
                      if(_descriptionController.text.isNotEmpty) {
                         homeProvider.searchByCode(_descriptionController.text.toString());
