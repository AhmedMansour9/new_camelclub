...
class ChangeStatusDialog extends StatefulWidget {
  ...
  ChangeStatusDialog({required this.status, required this.requestId});
...
class _ChangeStatusDialogState extends State<ChangeStatusDialog> {
                        ...
                        children: [
                            ...
                            child: Container(
                              padding: Provider.of<HomeProvider>(context,
                                  ...
                                  ? const EdgeInsets.only(
                                      right: 10, left: 10, top: 12, bottom: 10)
                          ...
                          Container(
                            ...
                            child: CustomButton(
                              ...
                              onTap: () async {
                                changeStatus(homeProvider, widget.status,
  ...
  void changeStatus(HomeProvider homeProvider, String status, String requestId,
    ...
    homeProvider
      ...
      if (value.isSuccess!) {
        showCustomSnackBar(
                getTranslated('sendto_consulnt', context),
                isError: false,
                context)
            .then((value) {
