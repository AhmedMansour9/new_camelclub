...
class Routes {
  ...
  static const String HOME_SCREEN = '/main';
  static const String HOMECLIENT_SCREEN = '/main_client';
  ...
  // static String getSubCategoryRoute(String catId,String catName) => '$SUBCATEGORY?id=$catId&name=$catName';
  ...
  static String getMainRoute() => HOME_SCREEN;
  static String getMainCLientRoute() => HOMECLIENT_SCREEN;
