...
class AppConstants {
 ...
 //  static const String BASE_URL = 'http://mahmoudabd2345-002-site4.ctempurl.com';
  ...
  static const String NOTIFICATIONS_URI = 'api/Notifications/GetNotificationByUserId';
  static const String REPORTSDATE_URI = 'api/RequestComplanit/ReportQueryByDate';
  static const String SUBCATEGORY_URI = 'api/CheckListComplanit/GetAllByCategory';
  static const String USER_TOKEN_URI = 'api/User/UpdateToken';
  static const String CHANGE_STATUS_URI = 'api/RequestComplanit/PostComplanitHistory';
  static const String POSTREADNOTIFICATION_URI = 'api/Notifications/PostReadNotification';
  static const String VERIFYCODEREQUEST_URI = 'api/RequestComplanit/VerificationCodeComplanit';
  static const String SENDREPORT_URI = 'api/RequestComplanit/PostListRequestComplanitCommand';
  static const String SENDFiltertion_URI = 'api/RequestComplanit/GetComplanitsByStatus';
   static const String SEARCHCODE_URI = 'api/RequestComplanit/GetComplanitQueryByCode';
  ...
  static const String REGISTER_URI = 'api/User/Register';
  ...
  static const String UPDATE_PROFILE_URI = 'api/UploadFile/UploadFile';
